...
### Día 2 — Ejercicio 02: Definición de entidades del dominio
  * Implementación de entities.py con las clases: EntidadBase, Categoria, Proveedor, Moneda, TipoCotizacion, Precio, CotizacionDolar, Producto y Stock.
  * Aplicación de encapsulamiento con propiedades y setters.
  * Validaciones de negocio: precio no negativo, cotización positiva, stock >= 0.
  * Uso de type hints y documentación PEP8 en todas las clases y métodos.
